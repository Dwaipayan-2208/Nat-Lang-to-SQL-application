# Nat-Lang-to-SQL-application
A Streamlit web application that converts natural language queries into SQL using OpenAI and executes them on a MySQL database."🗄️ Database
